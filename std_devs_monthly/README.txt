...
This indicator draws levels from the Monthly Open and is designed to work in Pine Editor, which is found in TradingView charting platform.
...
4 ⁃ Copy and paste the code from 'std_devs_monthly.pine'.

4 ⁃ Click “Add to Chart” to see the strategy/indicator.

5 ⁃ Adjust parameters (if any) in the settings. _(works in any given timeframe)_

**□ Example**

This strategy is just an algorithmic confluence for already existing trading strategies.
